...
function TaskTableHeader(props) {
  return (
    <thead>
      <tr>
        <th
          className="px-4 py-2 text-left text-gray-dark uppercase tracking-wider cursor-pointer"
        ...
        <th className="px-4 py-2 text-left text-gray-dark uppercase tracking-wider">
          Actions
        </th>
      </tr>
    </thead>
